    ...
    .then(input => {
      ...
      while (i < inputArr.length) {
        ...
        if (opCode === 1) {
          ...
          console.log(inputArr[inputArr[i + 1]]);
          i -= 2;
        } else if (opCode === 5) {
          if (num1 !== 0) {
            i = num2;
